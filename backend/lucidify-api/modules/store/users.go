...
func (s *Store) CreateUserInUsersTable(user User) error {
...
func (s *Store) UpdateUserInUsersTable(user User) error {
...
func (s *Store) GetUserInUsersTable(userID string) (*User, error) {
...
func (s *Store) DeleteUserInUsersTable(userID string) error {
